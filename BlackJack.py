...
class NuMaiJocException(Exception):

    pass

#blocul de generare pachet
my_pachet = Pachet([])
...
def incepe_joc(founds):
    ...
    elif joaca_iar.lower() == 'nu':

        raise NuMaiJocException
